...
public static class SeedDefaultTicketHistoryItems
{
    // TicketHistory StatusChangeOne = new TicketHistory()
    // {
    //     TicketId = dummy.Id,
    //     UserId = dummy["dummy"],
    //     Created = dummy.Created + new TimeSpan(days: 1, hours: 4, minutes: 8, seconds: 0),
    //     Description = $" made the following changes:</br><ul>{Environment.NewLine}<li>Changed the ticket status to <strong>Complete</strong></li></ul>"
    // };
    //     
    // TicketHistory StatusChangeTwo = new TicketHistory()
    // {
    //     TicketId = dummy.Id,
    //     UserId = dummy["dummy"],
    //     Created = dummy.Created + new TimeSpan(days: 1, hours: 4, minutes: 8, seconds: 0),
    ...
    // };
    //     
    // TicketHistory StatusChangeThree = new TicketHistory()
    // {
    //     TicketId = dummy.Id,
    //     UserId = dummy["dummy"],
    //     Created = dummy.Created + new TimeSpan(days: 1, hours: 4, minutes: 8, seconds: 0),
    ...
    // };
    //     
    // TicketHistory StatusChangeFour = new TicketHistory()
    // {
    //     TicketId = dummy.Id,
    //     UserId = dummy["dummy"],
    //     Created = dummy.Created + new TimeSpan(days: 1, hours: 4, minutes: 8, seconds: 0),
    ...
    //
    //
    // public static async Task SeedAsimovHistoryItemsAsync(ApplicationDbContext context, IITTicketHistoryService ticketHistoryService, SortedList<string,string> asimovMembers)
    // {
    ...
    //         };
        // #endregion
        //
        // #region PortfolioTicketTwo
        //
        // #endregion 
        //
        // #region PortfolioTicketThree
        //
        // #endregion 
    ...
    // }
    //
    // public static async Task SeedLinuxHistoryItemsAsync(ApplicationDbContext context, IITTicketHistoryService ticketHistoryService, SortedList<string,string> linuxMembers)
    // {
    //     #region BlogWebApp
