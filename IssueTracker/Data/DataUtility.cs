...
public static class DataUtility
{
    //Company Ids
        ...
        public static async Task SeedDefaultUsersAsync(UserManager<ITUser> userManager)
        {
            ...
            {
                UserName = "ITadmin1@bugtracker.com",
                Email = "ITadmin1@bugtracker.com",
                FirstName = "Bill",
                LastName = "Appuser",
                EmailConfirmed = true,
                CompanyId = company1Id
            ...
            {
                UserName = "ITadmin2@bugtracker.com",
                Email = "ITadmin2@bugtracker.com",
                FirstName = "Steve",
                LastName = "Appuser",
                EmailConfirmed = true,
                CompanyId = company2Id
        ...
        public static async Task SeedDemoUsersAsync(UserManager<ITUser> userManager)
        {
        ...
        {
            //Get project Ids
            int portfolioId = context.Projects.FirstOrDefault(p => p.Name == "Personal Porfolio Web Application").Id;
